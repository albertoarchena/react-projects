...
const Navbar = () => {
  ...
  return (
    <div className={`${isScrolled ? "sticky top-0 bg-[#1a232e] bg-opacity-80 backdrop-filter backdrop-blur-sm" : "bg-transparent"} duration-500 transition-all`}>
      <nav className={`flex justify-between items-center max-w-[1240px] lg:mx-auto mx-4  ${ isScrolled ? "h-16" : "h-24"} transition-all duration-500`}>
        ...
        <div className="hidden md:flex justify-between gap-4 items-center ">
          <ul className="flex">
            <li className="p-4">
              <a className="hover:text-white" href="/Projects">Projects</a></li>
            <li className="p-4">
              <a className="hover:text-white" href="/Experiece">Experience</a>
            </li>
            <li className="p-4">
          ...
          <div>
            <button className="bg-transparent hover:bg-[#43455c] text-[#3bba9c] font-semibold py-2 px-4 border border-[#3bba9c] rounded-lg">Resume</button>
          </div>
        </div> 
